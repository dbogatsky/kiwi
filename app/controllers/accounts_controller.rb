...
class AccountsController < ApplicationController
  ...
  def schedule_meeting
    ...
    if params[:conversation_item][:item_type] == 'regular' && params[:starts_date].present?
      ...
      params[:conversation_item][:starts_at] = convert_datetime_to_utc(current_user.time_zone, params[:starts_date], "07:00:00")
    ...
    if @conversation_item.present? && params[:file].present?
      params[:file].values.each do |file|
        ...
        if(content_type == 'image/png' || content_type == 'image/gif' || content_type == 'image/jpg' || content_type == 'image/jpeg')
          ...
          type = 'Media::Audio'
        elsif (content_type == 'video/x-flv' || content_type == "video/mp4" || content_type == 'video/MP2T' || content_type == 'video/3gpp' || content_type == 'video/quicktime' || content_type == 'video/x-msvideo' || content_type == 'video/x-ms-wmv' || content_type == 'video/mpeg')
          type = 'Media::Video'
        end
        params[:conversation_item] = {}
